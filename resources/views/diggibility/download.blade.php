...
<style>
  @page {
    size: A4;
    margin: 0; /* Margin dipindahkan ke wrapper agar konsisten di PDF maupun Gambar */
  ...
  *, *::before, *::after {
  ...
  /* Pembungkus utama untuk memberi margin/jarak di sekeliling gambar */
  .page-wrapper {
    width: 800px; /* Lebar standar laporan agar proporsional saat di-render */
    margin: 0 auto;
    padding: 30px 28px 24px 28px; /* Margin atas, kanan, bawah, kiri */
    background-color: #ffffff;
    box-sizing: border-box;
  }
...
<body>
  ...
  <!-- Wrapper Utama untuk Margin / Padding Gambar -->
