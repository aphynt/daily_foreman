                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript: void(0)">Daftar Laporan Kata Sandi</a></li>
                        </ul>
                    </div>
                    <div class="col-12">
                                ...
                                <tbody>
                                    @foreach ($kataSandi as $ks)
                                        <tr>
                                            ...
                                            <td>{{ $ks->pic }}</td>
                                            <td>
                                                <a href="{{ route('laporan-kata-sandi.preview', $ks->uuid) }}"><span class="badge bg-success">Preview</span></a>
                                                @if (Auth::user()->role == 'ADMIN')
                                                    <a href="#"><span class="badge bg-danger" data-bs-toggle="modal" data-bs-target="#deleteLaporanKataSandi{{ $ks->uuid }}"><i class="fas fa-trash-alt"></i> Hapus</span></a>
                                                @endif
                                            </td>
                                        </tr>
