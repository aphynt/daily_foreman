...
<head>
    ...
    <title>FM-SE-72 - Laporan Kegiatan Harian & Job Pending Safety ERT</title>
   <style>
    @page {
        size: A4 portrait;
...
<body>
    ...
    <div class="page">
        <div class="topbar">
            <table>
                <tr>
                    ...
                    <td class="code-cell">FM-SE-76/00/11/03/26</td>
                </tr>
            </table>
        </div>
        ...
        <div class="title-wrap">
            ...
            <div class="subtitle">SECTION EMERGENCY RESPONSE TEAM (ERT)</div>
        </div>
        ...
        <table class="meta-table">
            ...
            <tr>
                ...
                <td class="value">{{ ($data['daily']->position ?? 'Foreman / Supervisor') }} <i>(ERT Dedicate)</i></td>
            </tr>
        </table>
                ...
                @foreach ($data['sub'] as $sub)
                    <tr>
                        ...
                        <td class="status-cell">
                            @php
                                $status = trim((string) ($sub->status ?? ''));
                            @endphp

                            @if (in_array($status, ['1', 'v', 'V', 'check', 'checked', 'ok', 'ya', '✓', '✔', '√']))
                                &#10003;
                            @elseif (in_array($status, ['0', 'x', 'X', 'no', 'tidak', '✗', '✘']))
                                &#10007;
                            @else
                                &ndash;
                            @endif
    ...
    <div class="page">
        <div class="topbar">
            <table>
                <tr>
                    <td class="logo-cell">
                        <img src="{{ public_path('dashboard/assets/images/logo-full.png') }}" alt="Logo" class="logo">
                    </td>
                    ...
                    <td class="keterangan-cell">
                        <div class="keterangan-wrap">
                            ...
                            @if (!empty($temuan->foto_temuan))
                                <div class="keterangan-photos">
                                    <div class="keterangan-photo-box">
                                        <img src="{{ $temuan->foto_temuan }}" alt="Foto Kegiatan">
                                    </div>
                                </div>
                            @endif
                        </div>
                    ...
                    <td class="keterangan-cell">
                        <div class="keterangan-wrap">
                            ...
                            @if (!empty($pending->foto_pending))
                                <div class="keterangan-photos">
                                    <div class="keterangan-photo-box">
                                        <img src="{{ $pending->foto_pending }}" alt="Foto Kegiatan">
                                    </div>
                                </div>
                            @endif
                        </div>
        ...
        <table class="signature-table">
            ...
            <tbody>
                <tr>
                    <td>
                        <div class="signature-name"> @if ($data['daily']->verified_petugas != null)<img src="{{ $data['daily']->verified_petugas }}" style="max-width: 70px;">@endif</div>
                    ...
                    <td>
                        <div class="signature-name">@if ($data['daily']->verified_penerima != null)<img src="{{ $data['daily']->verified_penerima }}" style="max-width: 70px;">@endif</div>
                    ...
                    <td>
                        <div class="signature-name">@if ($data['daily']->verified_superintendent != null)<img src="{{ $data['daily']->verified_superintendent }}" style="max-width: 70px;">@endif</div>
