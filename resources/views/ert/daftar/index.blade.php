                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript: void(0)">Daftar Laporan Harian Safety ERT</a></li>
                        </ul>
                    </div>
                    <div class="col-12">
                                    ...
                                    @foreach ($daily as $item)
                                        <tr>
                                            ...
                                            @if ($item->verified_penerima == null)
                                                <td>{{ $item->nama_penerima }} <span class="badge bg-danger">B</span></td>
                                            @else
                                                <td>{{ $item->nama_penerima }} <span class="badge bg-success">T</span></td>
                                            @endif
                                            ...
                                            <td>
                                                <a href="{{ route('ert.preview', $item->uuid) }}"><span class="badge bg-success">Preview</span></a>
                                                @if (Auth::user()->role == 'ADMIN')
                                                    <a href="#"><span class="badge bg-danger" data-bs-toggle="modal" data-bs-target="#deleteLaporanKerjaERT{{ $item->uuid }}"><i class="fas fa-trash-alt"></i> Hapus</span></a>
                                                @endif
                                            </td>
                                        </tr>
                                    @include('ert.delete')
