@include('layout.head', ['title' => 'Laporan Harian SE Section ERT'])
        ...
        <div>
            <div id="basicwizard" class="form-wizard row justify-content-center">
                <div class="col-sm-12 col-md-6 col-xxl-4 text-center">
                    <h3>Laporan Harian SE Section ERT</h3>
                </div>
                <div class="col-12">
                    <div class="card">
                                    ...
                                    <div class="tab-pane" id="unitPitstop">
                                        ...
                                        <div class="row mt-2">
                                            <div class="mt-2">
                                                ...
                                                @include('ert.modal.sub-kegiatan')
                                    ...
                                    <div class="tab-pane" id="temuanTindakLanjut">
                                        ...
                                        <div class="row mt-2">
                                            <div class="mt-2">
                                                ...
                                                @include('ert.modal.temuan-tindak-lanjut')
            ...
            if (data.success) {
                ...
                Swal.fire({
                    ...
                    if (actionType === 'finish') {
                        window.location.href = "{{ route('ert.show') }}";
                    } else {
                        location.reload();
                    }
                });
    ...
    function hapusSubKegiatan(accordionIdSubKegiatan) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                if (subKegiatanId) {
                    fetch(`/delete-ert-subKegiatan/${subKegiatanId}`, {
                        method: 'DELETE',
                        headers: {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                if (temuanTindakLanjutId) {
                    fetch(`/delete-ert-temuanTindakLanjut/${temuanTindakLanjutId}`, {
                        method: 'DELETE',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
...
<script>
    ...
    function hapusJobPending(accordionId) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                if (jobPendingId) {
                    fetch(`/delete-ert-jobPending/${jobPendingId}`, {
                        method: 'DELETE',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
