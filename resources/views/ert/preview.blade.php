@include('layout.head', ['title' => 'Laporan Kegiatan Harian & Job Pending ERT'])
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="row align-items-center g-2 text-center text-sm-start">
                                    ...
                                    <div class="col-12 col-sm-6 text-sm-end">
                                        <h6 class="mb-0">FM-SE-76/00/11/03/26</h6>
                                    </div>
                                </div>
                            </div>
                            ...
                            <h3 class="text-center">
                                ...
                                <br>
                                <i>SECTION EMERGENCY RESPONSE TEAM (ERT)</i>
                            </h3>
                        ...
                        <div class="card-body p-3">
                            <div class="verifikasi-actions">
                                ...
                                @if ((Auth::user()->role == 'FOREMAN' || Auth::user()->role == 'SUPERVISOR') && $data['daily']->verified_penerima == null)
                                    <a href="{{ route('ert.verified.penerima', $data['daily']->uuid) }}" class="verifikasi-btn">
                                        Verifikasi Penerima
                                    </a>
                                @endif

                                @if (Auth::user()->role == 'SUPERINTENDENT' && $data['daily']->verified_superintendent == null)
                                    <a href="{{ route('ert.verified.superintendent', $data['daily']->uuid) }}" class="verifikasi-btn">
                        ...
                        <div class="action-actions">
                            ...
                            <a href="#" class="action-btn action-danger" data-bs-toggle="modal" data-bs-target="#deleteLaporanKerjaERT{{ $data['daily']->uuid }}">
                                Hapus
                            </a>
                            <div class="modal fade" id="deleteLaporanKerjaERT{{ $data['daily']->uuid }}" aria-hidden="true" aria-labelledby="..." tabindex="-1">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-body text-center p-5">
                                            ...
                                            <div class="mt-4 pt-4">
                                                ...
                                                <a href="{{ route('ert.delete', $data['daily']->uuid) }}"><span class="badge bg-danger" style="font-size:14px">Hapus</span></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <a href="{{ route('ert.pdf', $data['daily']->uuid) }}"
                            target="_blank"
                            class="action-btn action-primary">
                                Download PDF
                            </a>

                            <a href="{{ route('ert.download', $data['daily']->uuid) }}"
                            target="_blank"
