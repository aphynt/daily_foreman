                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-12">
                        <div class="mb-3 row">
                            ...
                            <div class="col-12 col-md-2 mb-2 d-flex align-items-end">
                                <a href="{{ route('jobpending.produksi.insert') }}" class="btn btn-success w-100" style="padding-top:10px;padding-bottom:10px;">
                                ...
                                <tbody>
                                    ...
                                    @foreach($data as $group)
                                        <tr>
                                            ...
                                            <td class="d-flex">
                                                <a href="{{ route('jobpending.produksi.show', $group->uuid) }}"
                                                ...
                                                @if ($group->verified_diterima == null)
                                                    <button type="button"
                                                        ...
                                                        data-url="{{ route('jobpending.produksi.verifikasi', $group->uuid) }}">
