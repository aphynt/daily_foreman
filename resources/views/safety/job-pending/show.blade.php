                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <form action="{{ route('jobpending.produksi.catatanPenerima', $data[0]->uuid) }}" method="post">
                                @csrf
                                <hr style="border: none; border-top: 2px dashed #000; height: 0; background: transparent;">
                            ...
                            <div class="card-body p-3">
                                @if ($data[0]->verified_diterima == null)
                                    <a href="#" data-bs-toggle="modal" ><span class="badge bg-success btn-verifikasi" style="font-size:14px"data-url="{{ route('jobpending.produksi.verifikasi', $data[0]->uuid) }}">
                                ...
                                <ul class="list-inline ms-auto mb-0 d-flex justify-content-end flex-wrap">
                                    ...
                                    <li class="list-inline-item align-bottom me-2">
                                        <a href="{{ route('jobpending.produksi.download', $data[0]->uuid) }}" target="_blank" class="avtar avtar-s btn-link-secondary">
                                            <i class="ph-duotone ph-download-simple f-22"></i>
                                        </a>
                                    </li>
                                    <li class="list-inline-item align-bottom me-2">
                                        <a href="{{ route('jobpending.produksi.cetak', $data[0]->uuid) }}" target="_blank" class="avtar avtar-s btn-link-secondary">
