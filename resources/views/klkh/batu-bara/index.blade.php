                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript: void(0)">Batubara</a></li>
                        </ul>
                    </div>
                    <div class="col-12">
                        <div class="mb-3 d-flex flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <form action="" method="get" class="d-flex align-items-center gap-2">
                                <div class="input-group input-group-sm" id="pc-datepicker-8">
                                    <input type="text" class="form-control" placeholder="Start date"
                                        name="rangeStart" style="max-width:160px" id="range-start">
                                    <span class="input-group-text">s/d</span>
                                    <input type="text" class="form-control" placeholder="End date"
                                        name="rangeEnd" style="max-width:160px" id="range-end">
                                </div>
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                @if (canAccess('klkh.batubara.insert'))
                                    <a href="{{ route('klkh.batubara.insert') }}" class="text-decoration-none">
                                        <span class="badge bg-success" style="font-size:14px">
                                            <i class="fas fa-plus"></i> Isi KLKH Batu Bara
                                        </span>
                                    </a>
                                @endif

                                {{-- ADMIN & MANAGEMENT : boleh download --}}
                                @if (canAccess('klkh.batubara.bundlepdf'))
                                    <a href="{{ route('klkh.batubara.bundlepdf') }}" target="_blank" class="text-decoration-none">
                                ...
                                <tbody>
                                    @foreach ($bb as $item)
                                        <tr>
                                            ...
                                            @endif
                                            <td>
                                                <a href="{{ route('klkh.batubara.preview', $item->uuid) }}" class="avtar avtar-s btn btn-primary btn-sm">
                                                ...
                                                @if (!in_array(Auth::user()->role, ['MANAGEMENT', 'SUPERINTENDENT SAFETY', 'SUPERVISOR SAFETY', 'FOREMAN SAFETY', 'PIT CONTROL']))
                                                <a href="#" class="avtar avtar-s btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteBB{{$item->id}}">
