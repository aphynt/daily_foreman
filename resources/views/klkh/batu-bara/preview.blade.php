                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="card-body p-3">
                                ...
                                @if(canAccess('klkh.batubara.verified.all'))
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#verifiedAll{{ $bb->uuid }}">
                                ...
                                @if(
                                    ...
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#verifiedForeman{{ $bb->uuid }}">
                                ...
                                @if(
                                    ...
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#verifiedSupervisor{{ $bb->uuid }}">
                                ...
                                @if(
                                    ...
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#verifiedSuperintendent{{ $bb->uuid }}">
