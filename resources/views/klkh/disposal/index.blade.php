                    ...
                    <div class="col-12">
                        <div class="mb-3 d-flex flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                {{-- FOREMAN & SUPERVISOR --}}
                                @if (canAccess('klkh.disposal.insert'))
                                    <a href="{{ route('klkh.disposal.insert') }}" class="text-decoration-none">
                                        <span class="badge bg-success" style="font-size:14px">
                                            <i class="fas fa-plus"></i> Isi KLKH Disposal/Dumping Point
                                        </span>
                                    </a>
                                @endif

                                {{-- ADMIN & MANAGEMENT --}}
                                @if (canAccess('klkh.disposal.bundlepdf'))
                                    <a href="{{ route('klkh.disposal.bundlepdf') }}" target="_blank" class="text-decoration-none">
                                ...
                                <tbody>
                                    @foreach ($disposal as $item)
                                        <tr>
                                            ...
                                            @endif
                                            <td>
                                                <a href="{{ route('klkh.disposal.preview', $item->uuid) }}" class="avtar avtar-s btn btn-primary btn-sm">
