                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript: void(0)">Intersection (Simpang Empat)</a></li>
                        </ul>
                    </div>
                    <div class="col-12">
                                    ...
                                    @foreach ($simpang as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="#" class="avtar avtar-s btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteSE{{$item->id}}">
                                        ...
                                        @include('klkh.simpang-empat.delete')
                                    @endforeach
