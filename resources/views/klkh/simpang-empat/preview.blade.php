                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-12">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-6 text-end">
                                        <h6 class="mb-0">FM-PRD-73/00/10/06/24</h6>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body p-3">
                                ...
                                @if(canAccess('klkh.simpangempat.verified.all'))
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#verifiedAll{{ $se->uuid }}">
                                ...
                                @if(
                                    ...
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#verifiedForeman{{ $se->uuid }}">
                                ...
                                @if(
                                    ...
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#verifiedSupervisor{{ $se->uuid }}">
                                ...
                                @if(
                                    ...
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#verifiedSuperintendent{{ $se->uuid }}">
