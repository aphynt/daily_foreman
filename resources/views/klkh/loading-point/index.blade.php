                                ...
                                <tbody>
                                    @foreach ($loading as $item)
                                        <tr>
                                            ...
                                            @endif
                                            <td>
                                                <a href="{{ route('klkh.loading-point.preview', $item->uuid) }}" class="avtar avtar-s btn btn-primary btn-sm">
                                                ...
                                                <a href="#" class="avtar avtar-s btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteLP{{$item->id}}">
                                        ...
                                        @include('klkh.loading-point.delete')
                                    @endforeach
