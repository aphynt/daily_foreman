                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-12">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-6 text-end">
                                        <h6 class="mb-0">FM-PRD-66/00/13/01/23</h6>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body p-3">
                                ...
                                @if(canAccess('klkh.lumpur.verified.all'))
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#verifiedAll{{ $lpr->uuid }}">
                                ...
                                @if(
                                    ...
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#verifiedForeman{{ $lpr->uuid }}">
                                ...
                                @if(
                                    ...
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#verifiedSupervisor{{ $lpr->uuid }}">
                                ...
                                @if(
                                    ...
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#verifiedSuperintendent{{ $lpr->uuid }}">
