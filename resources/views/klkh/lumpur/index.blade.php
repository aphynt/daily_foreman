                    ...
                    <div class="col-12">
                        <div class="mb-3 d-flex flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                {{-- FOREMAN & SUPERVISOR --}}
                                @if (canAccess('klkh.lumpur.insert'))
                                    <a href="{{ route('klkh.lumpur.insert') }}" class="text-decoration-none">
                                        <span class="badge bg-success" style="font-size:14px">
                                            <i class="fas fa-plus"></i> Isi KLKH Dumping Lumpur
                                        </span>
                                    </a>
                                @endif

                                {{-- ADMIN & MANAGEMENT --}}
                                @if (canAccess('klkh.lumpur.bundlepdf'))
                                    <a href="{{ route('klkh.lumpur.bundlepdf') }}" target="_blank" class="text-decoration-none">
                                ...
                                <tbody>
                                    @foreach ($lumpur as $item)
                                        <tr>
                                            ...
                                            @endif
                                            <td>
                                                <a href="{{ route('klkh.lumpur.preview', $item->uuid) }}" class="avtar avtar-s btn btn-primary btn-sm">
                                               ...
                                               @if (!in_array(Auth::user()->role, ['MANAGEMENT', 'SUPERINTENDENT SAFETY', 'SUPERVISOR SAFETY', 'FOREMAN SAFETY', 'PIT CONTROL']))
                                                <a href="#" class="avtar avtar-s btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteLPR{{$item->id}}">
