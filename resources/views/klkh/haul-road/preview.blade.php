                    ...
                    <div class="card-body">
                        <div class="row g-3">
                           <div class="col-12">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-6 text-end">
                                        <h6 class="mb-0">FM-PRD-51/01/18/10/22</h6>
                                    </div>
                            ...
                            <div class="col-sm-4">
                                <div class="border rounded p-3">
                                    ...
                                    @if ($hr->verified_foreman)
                                        <h5>
                                            <img src="{{ $hr->verified_foreman }}" style="max-width: 70px;">
                                        </h5>
                                    @endif

                                    <h5>{{ $hr->nama_foreman ?? '.......................' }}</h5>

                                    @if ($hr->catatan_verified_foreman)
                                        <p>
                            ...
                            <div class="col-sm-4">
                                <div class="border rounded p-3">
                                    ...
                                    @if ($hr->verified_supervisor)
                                        <h5>
                                            <img src="{{ $hr->verified_supervisor }}" style="max-width: 70px;">
                                        </h5>
                                    @endif

                                    <h5>{{ $hr->nama_supervisor ?? '.......................' }}</h5>

                                    @if ($hr->catatan_verified_supervisor)
                                        <p>
                                            <img src="{{ asset('dashboard/assets/images/widget/writing.png') }}" alt="">
                            ...
                            <div class="col-sm-4">
                                <div class="border rounded p-3">
                                    ...
                                    @if ($hr->verified_superintendent)
                                        <h5>
                                            <img src="{{ $hr->verified_superintendent }}" style="max-width: 70px;">
                                        </h5>
                                    @endif

                                    <h5>{{ $hr->nama_superintendent ?? '.......................' }}</h5>

                                    @if ($hr->catatan_verified_superintendent)
                                        <p>
                                            <img src="{{ asset('dashboard/assets/images/widget/writing.png') }}" alt="">
                           ...
                           <div class="card-body p-3">
                                ...
                                @if(canAccess('klkh.haul-road.verified.all'))
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#verifiedAll{{ $hr->uuid }}">
                                ...
                                @if(
                                    ...
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#verifiedForeman{{ $hr->uuid }}">
                                ...
                                @if(
                                    ...
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#verifiedSupervisor{{ $hr->uuid }}">
                                ...
                                @if(
                                    ...
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#verifiedSuperintendent{{ $hr->uuid }}">
