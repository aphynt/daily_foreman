                    ...
                    <div class="col-12">
                        <div class="mb-3 d-flex flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                {{-- FOREMAN & SUPERVISOR --}}
                                @if (canAccess('klkh.ogs.insert'))
                                    <a href="{{ route('klkh.ogs.insert') }}" class="text-decoration-none">
                                        <span class="badge bg-success" style="font-size:14px">
                                            <i class="fas fa-plus"></i> Isi KLKH OGS
                                        </span>
                                    </a>
                                @endif

                                {{-- ADMIN & MANAGEMENT --}}
                                @if (canAccess('klkh.ogs.bundlepdf'))
                                    <a href="{{ route('klkh.ogs.bundlepdf') }}" target="_blank" class="text-decoration-none">
