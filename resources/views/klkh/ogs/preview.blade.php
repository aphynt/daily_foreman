                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-6 text-end">
                                        <h6 class="mb-0">FM-PRD-71/01/16/02/26</h6>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="border rounded p-3">
                                    ...
                                    @if ($ogs->verified_foreman)
                                        <h5>
                                            <img src="{{ $ogs->verified_foreman }}" style="max-width: 70px;">
                                        </h5>
                                    @endif

                                    <h5>{{ $ogs->nama_foreman ?? '.......................' }}</h5>

                                    @if ($ogs->catatan_verified_foreman)
                                        <p>
                            ...
                            <div class="col-sm-4">
                                <div class="border rounded p-3">
                                    ...
                                    @if ($ogs->verified_supervisor)
                                        <h5>
                                            <img src="{{ $ogs->verified_supervisor }}" style="max-width: 70px;">
                                        </h5>
                                    @endif

                                    <h5>{{ $ogs->nama_supervisor ?? '.......................' }}</h5>

                                    @if ($ogs->catatan_verified_supervisor)
                                        <p>
                                            <img src="{{ asset('dashboard/assets/images/widget/writing.png') }}" alt="">
                            ...
                            <div class="col-sm-4">
                                <div class="border rounded p-3">
                                    ...
                                    @if ($ogs->verified_superintendent)
                                        <h5>
                                            <img src="{{ $ogs->verified_superintendent }}" style="max-width: 70px;">
                                        </h5>
                                    @endif

                                    <h5>{{ $ogs->nama_superintendent ?? '.......................' }}</h5>

                                    @if ($ogs->catatan_verified_superintendent)
                                        <p>
                                            <img src="{{ asset('dashboard/assets/images/widget/writing.png') }}" alt="">
                            ...
                            <div class="card-body p-3">
                                ...
                                @if(canAccess('klkh.ogs.verified.all'))
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#verifiedAll{{ $ogs->uuid }}">
                                ...
                                @if(
                                    ...
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#verifiedForeman{{ $ogs->uuid }}">
                                ...
                                @if(
                                    ...
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#verifiedSupervisor{{ $ogs->uuid }}">
                                ...
                                @if(
                                    ...
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#verifiedSuperintendent{{ $ogs->uuid }}">
