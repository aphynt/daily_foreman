<div class="modal fade" id="verifiedPengawas{{ $it->uuid }}" tabindex="-1" aria-labelledby="modalSupportLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('klkh.it.verified.pengawas', $it->uuid) }}" method="POST">
                @csrf
