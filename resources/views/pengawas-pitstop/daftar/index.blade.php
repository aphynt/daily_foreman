@include('layout.head', ['title' => 'Daftar Laporan Pengawas Pitstop'])
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript: void(0)">Daftar Laporan Pengawas Pitstop</a></li>
                        </ul>
                    </div>
                    <div class="col-12">
                                ...
                                <tbody>
                                    @foreach ($daily as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('pengawas-pitstop.preview', $item->uuid) }}"><span class="badge bg-success">Preview</span></a>
                                    ...
                                    @include('pengawas-pitstop.delete')
                                    @endforeach
                                </tbody>
                            </table>
                        </div>
