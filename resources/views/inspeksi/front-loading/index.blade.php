                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript: void(0)">Front Loading</a></li>
                        </ul>
                    </div>
                    <div class="col-12">
                        <div class="mb-3 d-flex flex-wrap flex-md-nowrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                {{-- FOREMAN & SUPERVISOR --}}
                                @if (canAccess('inspeksi.frontloading.insert'))
                                    <a href="{{ route('inspeksi.frontloading.insert') }}">
                                        <span class="badge bg-success px-3 py-2" style="font-size:14px">
                                            <i class="fas fa-plus"></i> Isi Inspeksi Front Loading
                                        </span>
                                    </a>
                                @endif
                                ...
                                {{-- ADMIN & MANAGEMENT --}}
                                {{--
                                @if (canAccess('inspeksi.frontloading.bundlepdf'))
                                    <a href="{{ route('inspeksi.frontloading.bundlepdf') }}" target="_blank">
                                ...
                                <tbody>
                                    @foreach ($fl as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('inspeksi.frontloading.preview', $item->uuid) }}" class="avtar avtar-s btn btn-primary btn-sm">
                                                ...
                                                <a href="#" class="avtar avtar-s btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteFL{{$item->id}}">
                                        ...
                                        @include('inspeksi.front-loading.delete')
                                    @endforeach
