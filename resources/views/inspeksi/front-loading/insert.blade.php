            ...
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-sm-12 col-md-6 col-xxl-4">
                        <h3>Inspeksi Tambang - Front Loading</h3>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="container mt-3">
                            <form action="{{ route('inspeksi.frontloading.post') }}" method="POST" id="submitformInspeksiFrontLoading">
                                @csrf
                                ...
                                <div class="text-center mt-3">
                                    <button type="submit" class="btn btn-primary btn-sm" id="submitButtonInspeksiFrontLoading">Submit</button>
                                </div>
                            </form>
...
<script>
    ...
    const formInspeksiFrontLoading = document.getElementById('submitformInspeksiFrontLoading');
    const submitButtonInspeksiFrontLoading = document.getElementById('submitButtonInspeksiFrontLoading');

    formInspeksiFrontLoading.addEventListener('submit', function() {
        // Nonaktifkan tombol submit ketika form sedang diproses
        submitButtonInspeksiFrontLoading.disabled = true;
        submitButtonInspeksiFrontLoading.innerText = 'Processing...';
        setTimeout(function() {
            submitButtonInspeksiFrontLoading.disabled = false;
            submitButtonInspeksiFrontLoading.innerText = 'Submit';
        }, 7000);
    });
</script>
