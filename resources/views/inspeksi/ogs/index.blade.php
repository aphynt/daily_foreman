@include('layout.head', ['title' => 'Inspeksi OGS'])
                    ...
                    <div class="col-12">
                        <div class="mb-3 d-flex flex-wrap flex-md-nowrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                {{-- FOREMAN & SUPERVISOR --}}
                                @if (canAccess('inspeksi.ogs.insert'))
                                    <a href="{{ route('inspeksi.ogs.insert') }}">
                                        <span class="badge bg-success px-3 py-2" style="font-size:14px">
                                            <i class="fas fa-plus"></i> Isi Inspeksi OGS
                                        </span>
                                    </a>
                                @endif
                                ...
                                {{-- ADMIN & MANAGEMENT --}}
                                {{--
                                @if (canAccess('inspeksi.ogs.bundlepdf'))
                                    <a href="{{ route('inspeksi.ogs.bundlepdf') }}" target="_blank">
                                ...
                                <tbody>
                                    @foreach ($ogs as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('inspeksi.ogs.preview', $item->uuid) }}" class="avtar avtar-s btn btn-primary btn-sm">
