                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript: void(0)">Ruang Office</a></li>
                        </ul>
                    </div>
                    <div class="col-12">
                        <div class="mb-3 d-flex flex-wrap flex-md-nowrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                {{-- FOREMAN & SUPERVISOR --}}
                                @if (canAccess('inspeksi.ruangoffice.insert'))
                                    <a href="{{ route('inspeksi.ruangoffice.insert') }}">
                                ...
                                <tbody>
                                    @foreach ($ro as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('inspeksi.ruangoffice.preview', $item->uuid) }}" class="avtar avtar-s btn btn-primary btn-sm">
                                                ...
                                                <a href="#" class="avtar avtar-s btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteRO{{$item->id}}">
                                        ...
                                        @include('inspeksi.ruang-office.delete')
                                    @endforeach
