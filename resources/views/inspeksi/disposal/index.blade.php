@include('layout.head', ['title' => 'Inspeksi Disposal'])
                    ...
                    <div class="col-12">
                        <div class="mb-3 d-flex flex-wrap flex-md-nowrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                {{-- FOREMAN & SUPERVISOR --}}
                                @if (canAccess('inspeksi.disposal.insert'))
                                    <a href="{{ route('inspeksi.disposal.insert') }}">
                                        <span class="badge bg-success px-3 py-2" style="font-size:14px">
                                            <i class="fas fa-plus"></i> Isi Inspeksi Disposal
                                        </span>
                                    </a>
                                @endif
                                ...
                                {{-- ADMIN & MANAGEMENT --}}
                                {{--
                                @if (canAccess('inspeksi.disposal.bundlepdf'))
                                    <a href="{{ route('inspeksi.disposal.bundlepdf') }}" target="_blank">
                                ...
                                <tbody>
                                    @foreach ($dp as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('inspeksi.disposal.preview', $item->uuid) }}" class="avtar avtar-s btn btn-primary btn-sm">
                                                ...
                                                <a href="#" class="avtar avtar-s btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteDP{{$item->id}}">
                                        ...
                                        @include('inspeksi.disposal.delete')
                                    @endforeach
