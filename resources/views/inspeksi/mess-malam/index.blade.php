                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript: void(0)">Mess (Malam)</a></li>
                        </ul>
                    </div>
                    <div class="col-12">
                        <div class="mb-3 d-flex flex-wrap flex-md-nowrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                {{-- FOREMAN & SUPERVISOR --}}
                                @if (canAccess('inspeksi.messmalam.insert'))
                                    <a href="{{ route('inspeksi.messmalam.insert') }}">
                                ...
                                <tbody>
                                    @foreach ($mm as $item)
                                        <tr>
                                            ...
                                            @if ($item->nik_inspektor != null)
                                                @if ($item->verified_inspektor == null)
                                                    <td>{{ $item->nik_inspektor }}</td>
                                                    <td>{{ $item->nama_inspektor }} <span class="badge bg-danger">B</span></td>
                                                @else
                                                    <td>{{ $item->nik_inspektor }}</td>
                                                    <td>{{ $item->nama_inspektor }} <span class="badge bg-success">T</span></td>
                                                @endif
                                            @else
                                                <td>{{ $item->nik_inspektor }}</td>
                                            ...
                                            @if ($item->nik_pendamping != null)
                                                @if ($item->verified_pendamping == null)
                                                    <td>{{ $item->nik_pendamping }}</td>
                                                    <td>{{ $item->nama_pendamping }} <span class="badge bg-danger">B</span></td>
                                                @else
                                                    <td>{{ $item->nik_pendamping }}</td>
                                                    <td>{{ $item->nama_pendamping }} <span class="badge bg-success">T</span></td>
                                                @endif
                                            @else
                                                <td>{{ $item->nik_pendamping }}</td>
                                            ...
                                            @endif
                                            <td>
                                                <a href="{{ route('inspeksi.messmalam.preview', $item->uuid) }}" class="avtar avtar-s btn btn-primary btn-sm">
                                                ...
                                                <a href="#" class="avtar avtar-s btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteMM{{$item->id}}">
                                        ...
                                        @include('inspeksi.mess-malam.delete')
                                    @endforeach
