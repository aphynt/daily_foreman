@include('layout.head', ['title' => 'Inspeksi Workshop'])
                    ...
                    <div class="col-12">
                        <div class="mb-3 d-flex flex-wrap flex-md-nowrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                {{-- FOREMAN & SUPERVISOR --}}
                                @if (canAccess('inspeksi.workshop.insert'))
                                    <a href="{{ route('inspeksi.workshop.insert') }}">
                                        <span class="badge bg-success px-3 py-2" style="font-size:14px">
                                            <i class="fas fa-plus"></i> Isi Inspeksi Workshop
                                        </span>
                                    </a>
                                @endif
                                ...
                                <tbody>
                                    @foreach ($ws as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('inspeksi.workshop.preview', $item->uuid) }}" class="avtar avtar-s btn btn-primary btn-sm">
                                                ...
                                                <a href="#" class="avtar avtar-s btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteWorkshop{{$item->id}}">
                                        ...
                                        @include('inspeksi.workshop.delete')
                                    @endforeach
