                                ...
                                <tbody>
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->pic_nama }}</td>
                                            <td>
                                                {{-- <a href="{{ route('inspeksi.tidakterencana.preview', $item->uuid) }}" class="avtar avtar-s btn btn-primary btn-sm">
                                                ...
                                                <a href="#" class="avtar avtar-s btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteInspeksiTidakTerencana{{$item->id}}">
                                        ...
                                        @include('inspeksi.tidak-terencana.delete')
                                    @endforeach
