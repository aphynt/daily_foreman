@include('layout.head', ['title' => 'Daftar Laporan Pengawas Coal'])
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript: void(0)">Daftar Laporan Pengawas Coal</a></li>
                        </ul>
                    </div>
                    <div class="col-12">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @if ($item->verified_supervisor == null)
                                            ...
                                            <td>
                                                {{-- <a href="{{ route('form-pengawas-batubara.download', $item->uuid) }}" target="_blank"><span class="badge bg-primary"><i class="fas fa-print"></i> Cetak</span></a> --}}
                                                <a href="{{ route('form-pengawas-batubara.preview', $item->uuid) }}"><span class="badge bg-success">Preview</span></a>
                                                @if (Auth::user()->role == 'ADMIN')
                                                    <a href="#"><span class="badge bg-danger" data-bs-toggle="modal" data-bs-target="#deleteLaporanKerjaBatubara{{ $item->uuid }}"><i class="fas fa-trash-alt"></i> Hapus</span></a>
                                                @endif
                                            </td>
                                    </tr>
                                    @include('form-pengawas-batubara.delete')
                                    @endforeach
                                </tbody>
