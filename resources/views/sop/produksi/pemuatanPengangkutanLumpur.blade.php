@include('layout.head', ['title' => 'SOP Pemuatan dan Pengangkutan Lumpur'])
            ...
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <li class="breadcrumb-item"><a href="javascript: void(0)">SOP Pemuatan dan Pengangkutan Lumpur</a></li>
                        </ul>
                    </div>
