@include('layout.head', ['title' => 'SOP Pengecekan dan Perbaikan Weakpoint'])
            ...
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <li class="breadcrumb-item"><a href="javascript: void(0)">SOP Pengecekan dan Perbaikan Weakpoint</a></li>
                        </ul>
                    </div>
