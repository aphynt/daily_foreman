...
class HazardReportController extends Controller
{
    ...
    public function post(Request $request)
    {
        ...
        try {
            ...
            HazardReport::create([
                ...
                'kategori_bahaya'           => $request->kategori_bahaya,
                'type_bahaya'               => $request->type_bahaya,
    ...
    public function update(Request $request, $uuid)
    {
        ...
        try {
            ...
            $detailTemuan = $request->input('detail_temuan', []);
            if (!is_array($detailTemuan)) {
                $detailTemuan = [];
            }
            $detailTemuan = array_values(
                array_unique(
                    array_filter(
                        array_map('trim', $detailTemuan)
                    )
                )
            );
            ...
            $updateData = [
                ...
                'kategori_bahaya'    => $request->has('kategori_bahaya') ? $request->kategori_bahaya : $data->kategori_bahaya,
                'type_bahaya'        => $request->has('type_bahaya') ? $request->type_bahaya : $data->type_bahaya,
