...
class JobPendingSafetyController extends Controller
{
    //
    public function index(Request $request)
    {
        ...
        $dataQuery = DB::table('se_job_pending  as jp')
        ...
        return view('safety.job-pending.index', compact('data', 'shift', 'section', 'filterShift', 'filterSection', 'filterDate'));
    }
    ...
    public function insert()
    {
        ...
        return view('safety.job-pending.insert', compact('data'));
    }
    ...
    {
        $data = DB::table('se_job_pending  as jp')
        ->leftJoin('se_job_pending_list as jd', 'jp.uuid', '=', 'jd.uuid_job')
        ->leftJoin('users as us', 'jp.pic', '=', 'us.id')
        ...
        return view('safety.job-pending.show', compact('data'));
    ...
    public function cetak($uuid)
    {
        ...
        return view('safety.job-pending.cetak', compact('data'));
    ...
    public function detail()
    {
        ...
        return view('safety.job-pending.detail', compact('data'));
    ...
    public function apiDetail(Request $request)
    {
        ...
        $supportQuery = DB::table('se_job_pending as jp')
            ->leftJoin('se_job_pending_list as jd', 'jp.uuid', '=', 'jd.uuid_job')
            ->leftJoin('users as us', 'jp.pic', '=', 'us.id')
            ->leftJoin('users as us2', 'jp.dibuat', '=', 'us2.nik')
            ->leftJoin('users as us3', 'jp.diterima', '=', 'us3.nik')
    ...
    public function download($uuid)
    {
        ...
        $pdf = PDF::loadView('safety.job-pending.download', compact('data'))->setPaper('a4', 'landscape');
