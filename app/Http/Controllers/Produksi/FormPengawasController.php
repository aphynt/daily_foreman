        ...
        try {
            return DB::transaction(function () use ($request) {
                ...
                if ($user->hasRoleId($roleSupervisor)) {
                    $dataToSave['nik_supervisor']      = $user->nik;
                    $dataToSave['nama_supervisor']     = $user->name;
                    $dataToSave['verified_supervisor'] = $user->nik;
                }

                if ($user->hasRoleId($roleForeman)) {
                    $dataToSave['nik_foreman']      = $user->nik;
                    $dataToSave['nama_foreman']     = $user->name;
                    $dataToSave['verified_foreman'] = $user->nik;
                }
