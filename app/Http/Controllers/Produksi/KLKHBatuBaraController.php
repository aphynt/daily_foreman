...
class KLKHBatuBaraController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $baseQuery = DB::table('prd_klkh_batubara as bb')
        ->leftJoin('users as us', 'bb.pic', '=', 'us.id')
        ->leftJoin('ref_region as ar', 'bb.pit_id', '=', 'ar.id')
        ...
        //         $query->where('bb.foreman', $user->nik)
        //             ->orWhere('bb.supervisor', $user->nik)
        //             ->orWhere('bb.superintendent', $user->nik);
        //     });
        // }
    ...
    {
        $bb = DB::table('prd_klkh_batubara as bb')
        ->leftJoin('users as us', 'bb.pic', '=', 'us.id')
        ->leftJoin('ref_region as ar', 'bb.pit_id', '=', 'ar.id')
        ->leftJoin('ref_shift as sh', 'bb.shift_id', '=', 'sh.id')
        ->leftJoin('users as us3', 'bb.foreman', '=', 'us3.nik')
