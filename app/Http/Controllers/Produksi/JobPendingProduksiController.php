...
class JobPendingProduksiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('produksi.job-pending.index', compact('data', 'shift', 'section', 'filterShift', 'filterSection', 'filterDate'));
    }
    ...
    public function insert()
    {
        ...
        return view('produksi.job-pending.insert', compact('data'));
    }
    ...
    {
        $data = DB::table('prd_job_pending  as jp')
        ...
        return view('produksi.job-pending.show', compact('data'));
    ...
    public function cetak($uuid)
    {
        ...
        return view('produksi.job-pending.cetak', compact('data'));
    ...
    public function detail()
    {
        ...
        return view('produksi.job-pending.detail', compact('data'));
    ...
    public function apiDetail(Request $request)
    {
        ...
        $supportQuery = DB::table('prd_job_pending as jp')
            ->leftJoin('prd_job_pending_list as jd', 'jp.uuid', '=', 'jd.uuid_job')
            ->leftJoin('users as us', 'jp.pic', '=', 'us.id')
            ->leftJoin('users as us2', 'jp.dibuat', '=', 'us2.nik')
            ->leftJoin('users as us3', 'jp.diterima', '=', 'us3.nik')
    ...
    public function download($uuid)
    {
        ...
        $pdf = PDF::loadView('produksi.job-pending.download', compact('data'))->setPaper('a4', 'landscape');
