...
class FormPengawasBatuBaraController extends Controller
{
    ...
    public function show(Request $request)
    {
        ...
        $daily = DB::table('prd_coal_foreman_daily_report as dr')
    ...
    public function preview($uuid)
    {
        ...
        // ->leftJoin('prd_ref_subcont_PENGAWAS as pg', 'lp.pengawas', '=', 'pg.id')
        ...
        // ->leftJoin('prd_ref_subcont_UNIT as su', 'us.nomor_unit', '=', 'su.id')
        ...
        $catatan = DB::table('prd_coal_foreman_note as cp')
        ->leftJoin('prd_coal_foreman_daily_report as dr', 'cp.daily_report_id', '=', 'dr.id')
        ->leftJoin('ref_shift as sh', 'dr.shift_dasar_id', '=', 'sh.id')
        ->leftJoin('users as us3', 'dr.nik_foreman', '=', 'us3.nik')
        ->leftJoin('users as us4', 'dr.nik_supervisor', '=', 'us4.nik')
        ->leftJoin('users as us5', 'dr.nik_superintendent', '=', 'us5.nik')
    ...
    public function download($uuid)
    {
        ...
        // ->leftJoin('prd_ref_subcont_UNIT as su', 'us.nomor_unit', '=', 'su.id')
        ->leftJoin('prd_ref_subcont_jenis_support as js', 'us.jenis', '=', 'js.id')
        ->leftJoin('ref_region as ar', 'us.area', '=', 'ar.id')
        ->leftJoin('ref_shift as sh', 'dr.shift_dasar_id', '=', 'sh.id')
        ->leftJoin('users as us3', 'dr.nik_foreman', '=', 'us3.nik')
        ->leftJoin('users as us4', 'dr.nik_supervisor', '=', 'us4.nik')
        ->leftJoin('users as us5', 'dr.nik_superintendent', '=', 'us5.nik')
    ...
    public function post(Request $request)
    {
        ...
        Log::create([
            ...
            'nik' => Auth::user()->nik,
            'keterangan' => 'Tambah laporan kerja batu bara dengan nama: '. Auth::user()->name . ', NIK: '. Auth::user()->nik .
